...
const locales = {
    en: {
        ...
        'orders.kanban.pending.singular': 'Pending',
        'orders.kanban.inProgress.singular': 'In Progress',
        'orders.kanban.in-progress.singular': 'In Progress',
        'orders.kanban.in-progress': 'In Progress',
        'orders.kanban.ready.singular': 'Ready',
        'orders.kanban.completed.singular': 'Completed',
        'orders.kanban.cancelled.singular': 'Cancelled',
        ...
        'orders.card.btn.cancel': 'Cancel Order',
        'orders.card.confirmCancel': 'Are you sure you want to cancel this order? Ingredients will be returned to stock.',
        ...
        'orders.modal.anonymous': 'Walk-in Customer',
        'orders.modal.outOfStock': 'Out of Stock',
        'orders.modal.notEnoughStock': 'Not enough stock',
        ...
        'payment.cardDigits': 'Last 4 Digits (Optional)',
        'payment.confirm': 'Confirm & Generate Invoice',
        'payment.insufficient': 'Amount received is invalid or insufficient.',
        ...
        'history.col.order': 'Order #',
        'history.col.date': 'Date & Time',
        'history.col.customer': 'Customer',
        'history.col.total': 'Total Amount',
        'history.col.status': 'Status',
        'history.col.action': 'Action',
        'history.empty': 'No completed orders found.',
        'history.modal.title': 'Order Details',
        'history.modal.items': 'Items',
        'history.modal.qty': 'Qty',
        'history.modal.price': 'Price',
        'history.modal.subtotal': 'Subtotal',
        'history.modal.tax': 'Tax',
        'history.modal.total': 'Total',
    ...
    es: {
        ...
        'orders.kanban.pending.singular': 'Pendiente',
        'orders.kanban.inProgress.singular': 'En Preparación',
        'orders.kanban.in-progress.singular': 'En Preparación',
        'orders.kanban.in-progress': 'En Preparación',
        'orders.kanban.ready.singular': 'Lista',
        'orders.kanban.completed.singular': 'Completada',
        'orders.kanban.cancelled.singular': 'Cancelada',
        ...
        'orders.card.btn.cancel': 'Cancelar Orden',
        'orders.card.confirmCancel': '¿Seguro que deseas cancelar esta orden? Los ingredientes se devolverán al inventario.',
        ...
        'orders.modal.anonymous': 'Anónimo',
        'orders.modal.outOfStock': 'Sin Stock',
        'orders.modal.notEnoughStock': 'Stock Insuficiente',
        
        // Payment & Invoice (es)
        'payment.title': 'Detalles de Pago',
        'payment.method': 'Método de Pago',
        'payment.cash': 'Efectivo',
        'payment.card': 'Tarjeta',
        'payment.amountReceived': 'Monto Recibido',
        'payment.change': 'Vuelto',
        'payment.cardDigits': 'Últimos 4 dígitos (Opcional)',
        'payment.confirm': 'Confirmar y Generar Factura',
        'payment.insufficient': 'El monto recibido es inválido o insuficiente.',
        'invoice.title': 'FACTURA',
        'invoice.thanks': 'GRACIAS',
        ...
        'dishes.btn.view': 'Ver',
        'dishes.btn.save': 'Guardar Platillo',
        ...
        'settings.taxRate': 'Tasa de Impuestos (%)',
        ...
        'history.filter.all': 'Todos los Estados',
        'history.col.order': 'Orden #',
        'history.col.date': 'Fecha y Hora',
        'history.col.customer': 'Cliente',
        'history.col.total': 'Monto Total',
        'history.col.status': 'Estado',
        'history.col.action': 'Acción',
        'history.empty': 'No hay órdenes completadas.',
        'history.modal.title': 'Detalles de Orden',
        'history.modal.items': 'Platillos',
        'history.modal.qty': 'Cant.',
        'history.modal.price': 'Precio',
        'history.modal.subtotal': 'Subtotal',
        'history.modal.tax': 'Impuestos',
        'history.modal.total': 'Total',
        ...
        'unit.Piece (pc)': 'pz',
        'unit.Cup': 'Taza',
        'unit.Tablespoon (tbsp)': 'cda',
        'unit.Teaspoon (tsp)': 'cdita',
        'unit.Pound (lb)': 'lb',
        'unit.Ounce (oz)': 'oz',
        'unit.Can': 'Lata',
        'unit.Bottle': 'Botella',
